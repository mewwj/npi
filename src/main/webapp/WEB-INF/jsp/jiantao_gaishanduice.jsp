		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
				<td>
					...
					<form action="/npi/msgs/insert_gaishanduice.do"  method="post">
										...
										<table cellspacing="0" cellpadding="0" style="width: 100%; border: solid 1px #a9c9ee" cellpadding="0" cellspacing="0">
											<tr style="height:30px; background-color:#e3ecfc">
												...
												<td style="width:30%;border-bottom:solid 1px #a9c9ee;">
													...
													<input type="text" value="${item.id}" name="headid" style="width:0;border:none;">
												</td>
									...
									<table class="dgdatagridStyle" cellspacing="0" id="msgtable" rules="all" border="1" style="width:100%;border-collapse:collapse;">
										...
										<tbody>
											...
											<tr>
												...
												<td class="dgdatagridTdNewStyle"><input type="text" value="${item.reasons}" name="reasons" class="text_input"/></td>
												<td class="dgdatagridTdNewStyle"><input type="text" value="${item.measures}" name="measures" class="text_input"/></td>
												<td class="dgdatagridTdNewStyle"><input type="text" value="${item.finishtime}" name="finishtime" class="text_input finishtime"/></td>
											</tr>
											</c:forEach>
										</tbody>
									</table>
