									...
									<table cellspacing="0" cellpadding="5" width='100%' border="0" style="border:solid 1px #a9c9ee;">
										<tbody>
											<tr>
												<td>
													<!-- 查詢內容顯示 開始 -->
													<form name="form1" action="/npi/head/update_head.do">
													...
													<tr style="height:30px;">
														...
														<td style="text-align: left;"><input type="text" name="cusname" id="InputCusname" value="${item.cusname}">
														<input type="text" name="id" value="${item.id }" style="width:0;border:none;"> 
														</td>
														<td style="text-align: right;">专案名称：</td>
														<td style="text-align: left;"><input type="text" name="proname"  id="InputProname" value="${item.proname}"></td>
													</tr>
													<tr style="height:30px;background-color:#e3ecfc">
														<td style="text-align: right;">选择阶段：</td>
														<td style="text-align: left;">
															<select name="stage0" id="stage0"    onchange="changeSelect(this.selectedIndex)">
																<option selected  disabled="disabled" >${item.stage0}</option>
															</select>
															<select name="stage" id="stage" >
															    <option selected  disabled="disabled" >${item.stage}</option>
															</select>
														</td>
														<td style="text-align: right;">机种代码：</td>
														<td style="text-align: left;"><input type="text" name="modeltype"  id="InputModel" value="${item.modeltype}"></td>
													</tr>
													<tr style="height:30px;">
														<td style="text-align: right;">试产日期：</td>
														<td style="text-align: left;"><input  type="text" id="trydate" name="trydate" class="form_datetime"  value="${item.trydate}"></td>
														<td style="text-align: right;">试产时间：</td>
														<td style="text-align: left;"><input type="text"  id="trytime" value="${item.trytime }" name="trytime"  class=" form_datetime" ></td>
													</tr>
													<tr style="height:30px;background-color:#e3ecfc">
														<td style="text-align: right;">生产班别：</td>
														<td style="text-align: left;"><input type="text"  id="team" name="team" value="${item.team }" ></td>
														<td style="text-align: right;">试产地点：</td>
														<td style="text-align: left;"><input type="text"  id="trialsite" name="trialsite" value="${item.trialsite }" ></td>
													</tr>
													<tr style="height:30px;">
														<td style="text-align: right;">投入数量：</td>
														<td style="text-align: left;"><input type="text"  id="number" name="number" value="${item.number }"></td>
														<td style="text-align: right;">良品数量：</td>
														<td style="text-align: left;"><input type="text"  id="goodnumber" name="goodnumber" value="${item.goodnumber }"></td>
													</tr>
													<tr style="height:30px;background-color:#e3ecfc">
